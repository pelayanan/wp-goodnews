   ...
   // executes this when the DOM is ready
	jQuery(function($){
		...
		<div class="mom_tiny_form">\
			...
			<div class="mom_tiny_desc">\
			<div class="mom_td_bubble">\
			    <label for="scrollbox-rows">Rows</label>\
			    <span>with this option you can display the scrolling box in multi rows, the default is 1</span>\
			</div>\
			</div>\
			<div class="mom_tiny_input">\
			    <input type="text" name="scrollbox-rows" id="scrollbox-rows">\
			</div>\
			<div class="clear"></div>\
		    </div>\
		    <!-- end element -->\
