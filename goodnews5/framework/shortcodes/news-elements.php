...
$output = get_transient('mom_feature_slider_'.$display.$category.$tag.$caption_style.$nav.$animation.$count);
if ($output == false) {
	ob_start();
global $da;
global $la;
...
if (in_array('both-sidebars',$classes)) {
	...
	?>
	<div class="feature-slider base-box <?php echo $wide_class; ?>" data-speed="<?php echo $speed; ?>" data-timeout="<?php echo $timeout; ?>" data-sanimation="<?php echo $animation; ?>" data-easing="<?php echo $easing; ?>" data-rndn="<?php echo $rndn; ?>">
		<?php if ($arrows == 'on') {?>
...
$output = get_transient('msb_'.$display.$category.$tag.$orderby.$excerpt_length.$count);
if ($output == false) {
	ob_start();
global $da;
global $la;
