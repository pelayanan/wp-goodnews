...
<?php wp_head(); ?>
    ...
    <?php //global $bp; echo '<pre>';print_r($bp); echo '</pre>'; ?>
    <body <?php body_class(); ?>>
    <?php do_action('mom_first_on_body'); ?>
	    ...
	    <?php do_action('mom_after_header'); ?>
			...
			echo do_shortcode('[news_ticker title="'.$nt_title.'" display="'.$nt_display.'" category="'.$nt_category.'" tag="'.$nt_tag.'" custom="'.$nt_custom.'" count="'.$nt_count.'" time="'.$nt_time.'" icon="'.$nt_icon_url.'" clock_only="'.$nt_clock_only.'" time_format="'.$nt_time_format.'" exclude_cats="'.$exclude_cats.'"]');
		    }
		?>
            </div>